...
void HRTIM_Init(void)
{
    ...
    HAL_HRTIM_WaveformCountStart_DMA(&hhrtim1, HRTIM_TIMERID_MASTER);
...
void MX_HRTIM1_Init(void)
{
  ...
  pADCTriggerCfg.Trigger = HRTIM_ADCTRIGGEREVENT13_TIMERB_CMP3|HRTIM_ADCTRIGGEREVENT13_MASTER_CMP2;
  ...
  pTimeBaseCfg.Period = HRTIMMaster_Period;
  ...
  pTimerCfg.DMARequests = HRTIM_MASTER_DMA_MCMP4;
  pTimerCfg.DMASrcAddress = (uint32_t)&HRTIM_DMA_Buffer[0];
  pTimerCfg.DMADstAddress = (uint32_t)&(HRTIM1->sCommonRegs.BDMADR);
  pTimerCfg.DMASize = 4;
  ...
  pCompareCfg.CompareValue = 25840;
  if (HAL_HRTIM_WaveformCompareConfig(&hhrtim1, HRTIM_TIMERINDEX_MASTER, HRTIM_COMPAREUNIT_4, &pCompareCfg) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_HRTIM_BurstDMAConfig(&hhrtim1, HRTIM_TIMERINDEX_MASTER, HRTIM_BURSTDMA_CMP1|HRTIM_BURSTDMA_CMP2
                              |HRTIM_BURSTDMA_CMP3|HRTIM_BURSTDMA_CMP4) != HAL_OK)
  {
    Error_Handler();
  }
  pTimeBaseCfg.Period = HRTIMA_Period;
  ...
  pTimeBaseCfg.Period = HRTIMB_Period;
...
void HAL_HRTIM_MspInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspInit 0 */
    ...
    /* HRTIM1 DMA Init */
    /* HRTIM1_M Init */
    hdma_hrtim1_m.Instance = DMA1_Channel6;
    ...
    hdma_hrtim1_m.Init.Priority = DMA_PRIORITY_VERY_HIGH;
